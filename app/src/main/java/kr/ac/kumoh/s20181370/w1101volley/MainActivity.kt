package kr.ac.kumoh.s20181370.w1101volley
...
import kr.ac.kumoh.s20181370.w1101volley.databinding.ActivityMainBinding
        ...
        binding.btnConnect.setOnClickListener {
            ...
            val request = JsonObjectRequest(
                ...
                null,
                {
                    movies.clear()
                    parseJson(it)
                    Toast.makeText(application, movies.toString().replace(",","\n").replace("[\\[\\]]".toRegex(), ""), Toast.LENGTH_LONG).show()
